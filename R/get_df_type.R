...
#' @examples
#' data(dietlein_data)
#' biotidyr:::get_df_type(dietlein_data)
#'
#' data(example_tall_df)
#' biotidyr:::get_df_type(example_tall_df)
#'
#' data(example_gvg_df)
#' biotidyr:::get_df_type(example_gvg_df)
#'
#' data(example_rvg_df)
#' biotidyr:::get_df_type(example_rvg_df)
#'
#' data(mtcars)
#' biotidyr:::get_df_type(mtcars)

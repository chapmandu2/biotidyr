...
dat1 <- convert_ids(data=dat1, id_data=dplyr::filter(CancerCellLineIDs, id_type=='CCLE'),
...
dat2 <- convert_ids(data=dat2, id_data=dplyr::filter(CancerCellLineIDs, id_type=='gdsc'),
